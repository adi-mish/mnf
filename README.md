...
- `mnf/benchmarks`: synthetic ground-truth systems for causal chains, sparse superposition, hierarchical absorption, cyclic weekday features, and random-vs-trained controls.
- `mnf/experiments`: runnable demos for the benchmark families.
- `tests`: 16 passing tests that exercise all core components.
...
The repo was tested in the creation environment with Python 3.13.5.  All 16 tests passed.
